...
class ArticulosInventariosWidget extends StatefulWidget {
  @override
  _ArticulosInventariosWidgetState createState() =>
      _ArticulosInventariosWidgetState();
}

class _ArticulosInventariosWidgetState
    extends State<ArticulosInventariosWidget> {
  @override
  ...
  Future<String> _asyncInputDialog(BuildContext context, int idArticulo,
      String claveArticulo, ArticulosInventariosController _) async {
    String unidades = '';
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              child: Text('Aceptar'),
              onPressed: () async {
                int traspasoID = await _.addArticuloInventario(
